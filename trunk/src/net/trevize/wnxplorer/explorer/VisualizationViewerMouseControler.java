...
public class VisualizationViewerMouseControler implements MouseListener,
		MouseMotionListener {

	private VisualizationViewer<SynsetVertex, PointerEdge> vv;
	private Point drag_point;

	public VisualizationViewerMouseControler(
			VisualizationViewer<SynsetVertex, PointerEdge> vv) {
		this.vv = vv;
	}
