...
public class PopupPOSButton extends JToggleButton {
	...
	private TreeMap<POS, JCheckBox> pos_checkboxes;
	...
	public PopupPOSButton() {
		...
		pos_checkboxes = new TreeMap<POS, JCheckBox>();
	...
	public ArrayList<POS> getSelectedPOS() {
		ArrayList<POS> pos_list = new ArrayList<POS>();
		for (POS pos : pos_checkboxes.keySet()) {
