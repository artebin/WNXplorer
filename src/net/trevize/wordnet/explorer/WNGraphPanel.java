...
import net.trevize.wordnet.jung.PopupGraphMousePlugin;
import net.trevize.wordnet.jung.SemanticRelationEdge;
import net.trevize.wordnet.jung.SemanticRelationEdgeLabelTranformer;
import net.trevize.wordnet.jung.SynsetVertex;
import net.trevize.wordnet.jung.SynsetVertexLabelRenderer;
import net.trevize.wordnet.jung.SynsetVertexLabelTransformer;
import net.trevize.wordnet.jung.SynsetVertexShapeSizeAspect;
import net.trevize.wordnet.jung.SynsetVertexTooltip;
import net.trevize.wordnet.jung.VertexStrokeHighlight;
